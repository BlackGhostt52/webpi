        ...
        <div className="w-full flex justify-center pt-11 pb-10 items-center bg-zinc-100">
            <div className="w-[1140px]">
                <header className="flex items-center justify-between">
                    <h2 className="w-auto text-3xl font-medium">O que nossos consumidores dizem?</h2>
                    <div className="flex">
                ...
                <main className="w-[1140px] flex justify-between flex-wrap mt-7">
                    <div className="h-[262px] w-[360px] my-3 flex flex-col justify-center rounded-lg bg-zinc-200 p-7">
                        ...
                        <p className="text-sm mt-3">
                            ...
                            Provident enim, omnis iusto ad placeat animi soluta? 
                            Rem expedita beatae est illo nam, qui unde alias amet 
                            provident, porro, eius similique.
                        </p>
                        <div className="flex items-center gap-4 mt-3">
                            <img src="" alt="" className="bg-zinc-400 rounded-full w-[48px] h-[48px]" />
