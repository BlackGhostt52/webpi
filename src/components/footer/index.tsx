...
import { Facebook, Instagram, Mail, MapPin, MoveRight, Phone, Twitter } from "lucide-react"
    ...
    <div className="w-full h-72 bg-zinc-900 flex flex-col items-center justify-center">
        <div className="w-[1140px] flex justify-between">
          <div className="">
              <nav>
                ...
                <ul className="flex flex-col gap-y-4 mt-6">
                  ...
                  <li className="text-sm text-zinc-100 flex gap-4">
                    <MapPin className="text-zinc-100"/>
            ...
            <div className="">
              <nav>
                <strong className="text-sm text-zinc-100 font-bold">Informações</strong>
            ...
            <div className="">
            <nav>
                <strong className="text-sm text-zinc-100 font-bold">Serviços</strong>
                <ul className="flex flex-col gap-y-1 mt-2">
            ...
            <div className="">
                <strong className="text-sm text-zinc-100 font-bold">Inscreva-se</strong>
                <p className="w-[310px] text-sm text-zinc-100 mt-3 mb-[23px]">Lorem ipsum dolor, sit amet consectetur. Nisi, voluptas provident vero qui quisquam !</p>
                <div className="flex items-center border-2 border-zinc-100 rounded-lg py-1 px-3">
                  <Mail className="text-zinc-100"/>
                  <Input className="bg-transparent p-0 border-transparent text-zinc-100" />
                  <MoveRight className="text-zinc-100" />
                </div>
            </div>
          </div>
          <div className="w-[1140px] pt-3 mt-11 flex items-center justify-between border-t-[1px] border-zinc-100">
            ...
            <div className="text-zinc-100">&#9400;2024 Projeto Integrador | Fatec - Todos os direitos reservados</div>
            <div className="flex flex-row gap-3">
              <Facebook className="text-zinc-100"/>
              <Instagram className="text-zinc-100"/>
              <Twitter className="text-zinc-100"/>
            </div>
          </div>
    </div>
  )
